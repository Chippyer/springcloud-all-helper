...
public class LogFeignClientProcessor implements FeignClientProcessor {
    ...
    @Override
    public void processBefore(FeignClientDefinition.Element element, Object[] param) {
    ...
    @Override
    public void processAfter(FeignClientDefinition.Element element, Object object) {
        if (log.isDebugEnabled()) {
            log.debug(String
                .format(processAfterLogStr, element.getFullPath(), element.getMethod(), JSONUtil.toJsonStr(object)));
        }
    }
