package com.ejoy.feign.configuration;

import com.ejoy.feign.exception.HystrixPluginsException;
import com.ejoy.feign.support.strategy.RequestContextHystrixConcurrencyStrategy;
import com.ejoy.feign.support.wrapper.HystrixCallableWrapper;
import com.ejoy.feign.support.wrapper.RequestAttributeCallableWrapper;
...
public class FeignRequestConfiguration {
    ...
    @Bean
    public HystrixCallableWrapper requestAttributeCallableWrapper() {
